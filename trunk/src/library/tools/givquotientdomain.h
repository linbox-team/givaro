...
// Time-stamp: <30 Sep 09 09:32:31 Jean-Guillaume.Dumas@imag.fr> 
// Author: J-G. Dumas
...
public :
    ...
    Rep& init(Rep& a) const { return Ring_t::modin(Ring_t::init(a),_modulo); }
    ...
    int isZero  ( const Rep& P ) const { return Ring_t::isZero(P); }
    int isOne   ( const Rep& P ) const { return Ring_t::isOne(P); }
