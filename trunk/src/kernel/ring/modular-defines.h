...
// r <- a^-1
#define __GIVARO_MODULAR_INTEGER_NEG(r,p,a) ( r = a == 0 ? static_cast<Element>(0) : static_cast<Element>(static_cast<Compute_t>(p)-static_cast<Compute_t>(a)) )
#define __GIVARO_MODULAR_FLOATING_NEG(r,p,a) ( r = (a == 0 ? 0 : p-a) )
// r <- r^-1
#define __GIVARO_MODULAR_INTEGER_NEGIN(r,p) ( r = r == 0 ? static_cast<Element>(0) : static_cast<Element>(static_cast<Compute_t>(p)-static_cast<Compute_t>(r)) )
#define __GIVARO_MODULAR_FLOATING_NEGIN(r,p) ( r = (r == 0 ? 0 : p-r) )

// r <- a * b
#define __GIVARO_MODULAR_INTEGER_MUL(r,p,a,b) ( r = static_cast<Element>(static_cast<Compute_t>(a)*static_cast<Compute_t>(b) % static_cast<Compute_t>(p)) )
...
static_cast<Compute_t>(a)-static_cast<Compute_t>(b) : static_cast<Compute_t>(p)-static_cast<Compute_t>(b)+static_cast<Compute_t>(a)) )
...
{ r = static_cast<Element>(static_cast<Compute_t>(a) + static_cast<Compute_t>(b)); \
r = static_cast<Element>((static_cast<Compute_t>(r) < static_cast<Compute_t>(p)) ? r : static_cast<Compute_t>(r) - static_cast<Compute_t>(p)); }
#define __GIVARO_MODULAR_FLOATING_ADD(r,p,a,b) { r = (a+b); r= (r < p ? r : r-p); }
// r <- r + a
#define __GIVARO_MODULAR_INTEGER_ADDIN(r,p,a) \
{ r = static_cast<Element>(r + a); r = static_cast<Element>((static_cast<Compute_t>(r) < static_cast<Compute_t>(p)) ? r : static_cast<Compute_t>(r) - static_cast<Compute_t>(p)); }
#define __GIVARO_MODULAR_FLOATING_ADDIN(r,p,a) { r += a;  r= (r < p ? r : r-p); }

// r <- c + a*b
#define __GIVARO_MODULAR_INTEGER_MULADD(r,p,a,b,c) \
( r = static_cast<Element>((static_cast<Compute_t>(a)*static_cast<Compute_t>(b)+static_cast<Compute_t>(c)) % static_cast<Compute_t>(p)))
#define __GIVARO_MODULAR_FLOATING_MULADD(r,p,a,b,c) ( r = std::fmod((a*b+c), p) )
// r <- r + a*b
#define __GIVARO_MODULAR_INTEGER_MULADDIN(r,p,a,b) \
( r = static_cast<Element>((static_cast<Compute_t>(a)*static_cast<Compute_t>(b)+static_cast<Compute_t>(r)) % static_cast<Compute_t>(p)))
#define __GIVARO_MODULAR_FLOATING_MULADDIN(r,p,a,b) ( r = std::fmod((a*b+r), p) )

// r <- a*b - c
#define __GIVARO_MODULAR_INTEGER_MULSUB(r,p,a,b,c) \
( r = static_cast<Element>((static_cast<Compute_t>(a)*static_cast<Compute_t>(b)+static_cast<Compute_t>(p)-static_cast<Compute_t>(c)) % static_cast<Compute_t>(p)))
#define __GIVARO_MODULAR_FLOATING_MULSUB(r,p,a,b,c) ( r = std::fmod((a*b+p-c), p) )

// r <- r - a*b
#define __GIVARO_MODULAR_INTEGER_SUBMULIN(r,p,a,b) \
{ r = static_cast<Element>((static_cast<Compute_t>(a)*static_cast<Compute_t>(b)+static_cast<Compute_t>(p)-static_cast<Compute_t>(r)) % static_cast<Compute_t>(p)); \
