...
#define __GIVARO_MODULAR_FLOATING_MUL(r,p,a,b) ( r = fmod(a*b, p) )
// r <- r * a
#define __GIVARO_MODULAR_INTEGER_MULIN(r,p,a) ( r = Element( (Compute_t(r*a)) % Compute_t(p) ) )
#define __GIVARO_MODULAR_FLOATING_MULIN(r,p,a) ( r = fmod((r*a), p) )
...
#define __GIVARO_MODULAR_FLOATING_MULADD(r,p,a,b,c) ( r = fmod((a*b+c), p) )
// r <- r + a*b
#define __GIVARO_MODULAR_INTEGER_MULADDIN(r,p,a,b) \
( r = Element( Compute_t(a*b+r) % Compute_t(p) ) )
#define __GIVARO_MODULAR_FLOATING_MULADDIN(r,p,a,b) ( r = fmod((a*b+r), p) )

// r <- a*b - c
#define __GIVARO_MODULAR_INTEGER_MULSUB(r,p,a,b,c) \
( r = Element( Compute_t(a*b+p-c) % Compute_t(p) ) )
#define __GIVARO_MODULAR_FLOATING_MULSUB(r,p,a,b,c) ( r = fmod((a*b+p-c), p) )
...
{ r = (a*b+p-r); r= (r<p ? r : fmod(r, p)); __GIVARO_MODULAR_FLOATING_NEGIN(r,p); }
