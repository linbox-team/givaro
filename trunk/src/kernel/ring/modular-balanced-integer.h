...
// Authors: Brice Boyer <bboyer@imag.fr>
...
#ifndef __GIVARO_modular_balanced_integer_H
#define __GIVARO_modular_balanced_integer_H
	...
	/*template <>
		...
		typedef Integer Element;
			...
			Integer::seeding(seed);
                ...
                /*! @bug FIXME not so random... (at all)  */
...
#endif // __GIVARO_modular_balanced_integer_H
