...
#define __GIVARO_MODULAR_RECINT_LMUL(r,p,a,b) { Compute_t ldeftmp;RecInt::lmul(ldeftmp, a, b); RecInt::mod_n(r, ldeftmp, p); }
...
#define __GIVARO_MODULAR_RECINT_LMULIN(r,p,a) { Compute_t ldeftmp;RecInt::lmul(ldeftmp, r, a); RecInt::mod_n(r, ldeftmp, p); }
...
#define __GIVARO_MODULAR_RECINT_LMULADDIN(r,p,a,b) { \
    Element ldeftmp=r;				     \
    __GIVARO_MODULAR_RECINT_LMULADD(r,p,a,b,ldeftmp);} 
...
#define __GIVARO_MODULAR_RECINT_LSUBMULIN(r,p,a,b) { \
    Element ldeftmp=r;				     \
    __GIVARO_MODULAR_RECINT_LMULSUB(r,p,a,b,ldeftmp);} 
