 ...
 */
template<>
class Modular<uint32_t> : public RingInterface<uint32_t>
{
public:
	...
	static inline Residu_t getMaxModulus() { return 32768; } // 2^15
...
protected:
	...
	Element& invext(Element& u, const Element a, const Element b) const;
