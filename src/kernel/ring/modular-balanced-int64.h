...
namespace Givaro
{
    ...
    template <>
    class ModularBalanced<int64_t> : public RingInterface<int64_t>
    {
    public:
	...
	static inline Element getMaxModulus() { return 6074000999; } // 2^32.5
	static inline Element getMinModulus() { return 3; }
