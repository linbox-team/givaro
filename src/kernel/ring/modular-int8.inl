...
namespace Givaro {
    ...
    template<typename COMP>
    inline bool Modular<int8_t, COMP>::isUnit(const Element& a) const 
    { 
        Element u,d; 
        invext(u,d,a,int8_t(_p)); 
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init(Element& x) const
    {
        return x = zero;
    }
    
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const float y) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const double y) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const int16_t y) const
    {
        x = static_cast<Element>(y % int16_t(_p));
        if (x < 0) x = static_cast<Element>(x + _p);
        return x;
    }
    
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const uint16_t y) const
    {
        x = static_cast<Element>(y % uint16_t(_p));
        return x;
    }
    
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const int32_t y) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const uint32_t y) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const int64_t y) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const uint64_t y) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::init (Element& x, const Integer& y) const
    {
    ...
    template<typename COMP> inline  typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::assign ( Element& r, const Element& a ) const
    {
        return r = a;
    }
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::reduce(Element& r, const Element& a) const
    {
    ...
    template<typename COMP> inline typename Modular<int8_t, COMP>::Element&
    Modular<int8_t, COMP>::reduce(Element& r) const
    {
